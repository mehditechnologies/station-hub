      ...
      <div className="relative z-10 bg-white rounded-2xl p-8 w-full max-w-sm shadow-[0_8px_40px_rgba(0,0,0,0.18)]">
        ...
        <div className="flex flex-col items-center mb-6">
          <img
            ...
            className="w-[160px] h-[160px] object-contain mb-0"
          />
          <h1 className="text-[22px] font-bold text-black mb-1">
            Create Account
          </h1>
          <p className="text-xs text-gray-500 text-center">
            Start your journey with Station Hub
          </p>
        </div>
        ...
        <div className="flex items-start gap-2 mb-5">
          ...
          <p className="text-xs text-gray-500 leading-5">
            I agree to the{" "}
            <a href="/terms" className="text-orange-500 font-semibold">
              Terms of Service
            </a>{" "}
            and{" "}
            <a href="/privacy" className="text-orange-500 font-semibold">
              Privacy Policy
            </a>
          </p>
        </div>
        ...
        {/* Button */}
        <button
          className="w-full h-10 bg-orange-500 text-white rounded-xl font-bold text-[15px] flex items-center justify-center gap-2 mb-5"
          onClick={() => {}}
        >
          Create Account →
        </button>
