    ...
    >
      ...
      <div className="relative z-10 bg-white rounded-2xl shadow-2xl px-8 py-10 w-full max-w-sm flex flex-col items-center">
        ...
        <div className="w-full mb-4">
          ...
          <div className="flex items-center border border-gray-300 rounded-lg px-3 py-2 gap-2 focus-within:border-orange-500 transition-colors">
            <svg
        ...
        <div className="w-full flex gap-3 mb-6">
          <button
            ...
            className="hover:cursor-pointer flex-1 flex items-center justify-center gap-2 border border-gray-300 rounded-lg py-2.5 text-sm font-semibold text-gray-700 hover:bg-gray-50 transition-colors"
          >
